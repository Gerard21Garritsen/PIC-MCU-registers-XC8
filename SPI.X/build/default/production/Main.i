...
void SPIInitSlave(unsigned char smp,unsigned char cke,unsigned char ckp,unsigned char mode){
    ADCON1 = 0x0F;
    TRISAbits.RA5 = 1;
    TRISCbits.RC7 = 0;
    TRISBbits.RB0 = 1;
...
void main(void) {
    ...
    SPIInitMaster(0x00,0x00,0x00,0x00);
    ...
    while(1){
        ...
        SPIData(0xA6);
        _delay((unsigned long)((3000)*(4E6/4000.0)));
        SPIData(0x02);
        _delay((unsigned long)((3000)*(4E6/4000.0)));
        LATDbits.LATD3 = 1;
        _delay((unsigned long)((3000)*(4E6/4000.0)));
