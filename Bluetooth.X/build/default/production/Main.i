...
# 5 "USART.h"
void USART_Init(uint32_t FOSC,uint32_t BAUD);
void USART_Char(char caracter);
void USART_String(char *cata);
...
void main(void) {
char dato[20];
const char led1[] = "Led azul";
const char led2[] = "Led verde";
const char led3[] = "Led amarillo";

TRISCbits.TRISC0 = 0;
TRISCbits.TRISC1 = 0;
TRISCbits.TRISC2 = 0;
LATC = 0x00;
USART_Init(4000000,9600);
unsigned int periodo = 65535-(1E-3*4E6/64);
while(1){
printf("Valor timer: %u\n\r",periodo);
