...
void SPIData(unsigned char Data){
SSPBUF = Data;
_delay((unsigned long)((1)*(4E6/4000.0)));
}
...
LATDbits.LATD6 = 1;
_delay((unsigned long)((5)*(4E6/4000.0)));
LATDbits.LATD6 = 0;
_delay((unsigned long)((10)*(4E6/4000.0)));
LATDbits.LATD6 = 1;
_delay((unsigned long)((20)*(4E6/4000.0)));
...
void displayChar(unsigned char caracter){
for(uint8_t i = 0; i < 8; i++){
dataWrite(Font[caracter - 0x20][i]);
}
}
...
SPIInitMaster(0x00,0x00,0x01,0x00);
_delay((unsigned long)((10)*(4E6/4000.0)));
displayInit();
displayClear();
displayString(0,4,"PIC 18F4550");
_delay((unsigned long)((2000)*(4E6/4000.0)));
displayClear();
displayBitmap();
for(uint8_t i = 0; i < 10; i++){
displayInvert(0xA7);
_delay((unsigned long)((1000)*(4E6/4000.0)));
displayInvert(0xA6);
_delay((unsigned long)((1000)*(4E6/4000.0)));
}
