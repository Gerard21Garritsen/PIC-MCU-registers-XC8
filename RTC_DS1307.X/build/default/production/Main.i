...
void I2Cdata(uint8_t address, uint8_t data);
void I2Cstop(void);
void I2Creset(void);
void I2CACK(void);
void I2CNACK(void);
...
{
    LATDbits.LATD3 = 0; LATDbits.LATD2 = 0; LATDbits.LATD1 = 1; LATDbits.LATD0 = 1; LATDbits.LATD5 = 0;
    LATDbits.LATD4 = 0; LATDbits.LATD3 = 0; LATDbits.LATD2 = 0; LATDbits.LATD1 = 1; LATDbits.LATD0 = 1;
    LATDbits.LATD5 = 1; LATDbits.LATD4 = 0;
    _delay((unsigned long)((5)*(4000000/4000000.0)));
    LATDbits.LATD3 = 0; LATDbits.LATD2 = 0; LATDbits.LATD1 = 1; LATDbits.LATD0 = 1; LATDbits.LATD5 = 0;
    LATDbits.LATD4 = 0;
    _delay((unsigned long)((5500)*(4000000/4000000.0)));
}
LATDbits.LATD3 = 0; LATDbits.LATD2 = 0; LATDbits.LATD1 = 1; LATDbits.LATD0 = 0; LATDbits.LATD5 = 0; LATDbits.LATD4 = 0;
LATDbits.LATD3 = 0; LATDbits.LATD2 = 0; LATDbits.LATD1 = 1; LATDbits.LATD0 = 0; LATDbits.LATD5 = 1; LATDbits.LATD4 = 0;
_delay((unsigned long)((5)*(4000000/4000000.0)));
LATDbits.LATD3 = 0; LATDbits.LATD2 = 0; LATDbits.LATD1 = 1; LATDbits.LATD0 = 0; LATDbits.LATD5 = 0; LATDbits.LATD4 = 0;
_delay((unsigned long)((5500)*(4000000/4000000.0)));
...
void Lcd_Chr_CP(char data){
LATDbits.LATD5 = 0; LATDbits.LATD4 = 1;
LATDbits.LATD3 = (data & 0b10000000)>>7; LATDbits.LATD2 = (data & 0b01000000)>>6;
LATDbits.LATD1 = (data & 0b00100000)>>5; LATDbits.LATD0 = (data & 0b00010000)>>4;
_delay(10);
LATDbits.LATD5 = 1; _delay((unsigned long)((5)*(4000000/4000000.0))); LATDbits.LATD5 = 0;
LATDbits.LATD3 = (data & 0b00001000)>>3; LATDbits.LATD2 = (data & 0b00000100)>>2;
LATDbits.LATD1 = (data & 0b00000010)>>1; LATDbits.LATD0 = (data & 0b00000001);
_delay(10);
LATDbits.LATD5 = 1; _delay((unsigned long)((5)*(4000000/4000000.0))); LATDbits.LATD5 = 0;
...
void Lcd_Cmd(unsigned char data){
LATDbits.LATD5 = 0; LATDbits.LATD4 = 0;
LATDbits.LATD3 = (data & 0b10000000)>>7; LATDbits.LATD2 = (data & 0b01000000)>>6;
LATDbits.LATD1 = (data & 0b00100000)>>5; LATDbits.LATD0 = (data & 0b00010000)>>4;
_delay(10);
LATDbits.LATD5 = 1; _delay((unsigned long)((5)*(4000000/4000000.0))); LATDbits.LATD5 = 0;
